...
namespace MdxLib.ModelFormats.Xml
{
	internal sealed class CGeosetExtent : CObject
	{
		...
		public void Load(CLoader Loader, System.Xml.XmlNode Node, Model.CModel Model, Model.CGeoset Geoset, Model.CGeosetExtent GeosetExtent)
		{
			GeosetExtent.Extent = ReadExtent(Node, "extent", GeosetExtent.Extent);
		}

		public void Save(CSaver Saver, System.Xml.XmlNode Node, Model.CModel Model, Model.CGeoset Geoset, Model.CGeosetExtent GeosetExtent)
		{
