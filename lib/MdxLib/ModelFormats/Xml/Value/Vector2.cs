...
namespace MdxLib.ModelFormats.Xml.Value
{
	internal sealed class CVector2 : CUnknown, IValue<Primitives.CVector2>
	{
		...
		public Primitives.CVector2 Read(System.Xml.XmlNode Node, string Name, Primitives.CVector2 DefaultValue)
		{
			return ReadVector2(Node, Name, DefaultValue);
		}

		public void Write(System.Xml.XmlNode Node, string Name, Primitives.CVector2 Value)
		{
