...
namespace MdxLib.ModelFormats.Xml.Value
{
	internal sealed class CVector4 : CUnknown, IValue<Primitives.CVector4>
	{
		...
		public Primitives.CVector4 Read(System.Xml.XmlNode Node, string Name, Primitives.CVector4 DefaultValue)
		{
			return ReadVector4(Node, Name, DefaultValue);
		}

		public void Write(System.Xml.XmlNode Node, string Name, Primitives.CVector4 Value)
		{
