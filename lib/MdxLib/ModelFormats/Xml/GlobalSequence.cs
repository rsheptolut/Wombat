...
namespace MdxLib.ModelFormats.Xml
{
	internal sealed class CGlobalSequence : CObject
	{
		...
		public void Load(CLoader Loader, System.Xml.XmlNode Node, Model.CModel Model, Model.CGlobalSequence GlobalSequence)
		{
			GlobalSequence.Duration = ReadInteger(Node, "duration", GlobalSequence.Duration);
		}

		public void Save(CSaver Saver, System.Xml.XmlNode Node, Model.CModel Model, Model.CGlobalSequence GlobalSequence)
		{
