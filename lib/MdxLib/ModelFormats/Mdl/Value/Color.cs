...
{
	internal sealed class CColor : CUnknown, IValue<Primitives.CVector3>
	{
		private CColor()
		{
			//Empty
		...
		public void Write(CSaver Saver, Primitives.CVector3 Value)
		{
			Saver.WriteColor(Value);
		}

		public bool ValidCondition(Primitives.CVector3 Value, ECondition Condition)
		{
			switch(Condition)
			{
