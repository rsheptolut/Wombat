...
namespace MdxLib.Model
{
	...
	public sealed class CGeosetGroupNode : CObject<CGeosetGroupNode>
	{
		...
		public CGeosetGroupNode(CModel Model) : base(Model)
		{
			//Empty
		}
		...
		{
			return "Geoset Group Node #" + ObjectId;
		}

		/// <summary>
		/// Retrieves the node reference.
		/// </summary>
		public CNodeReference Node
		{
			get
			{
				return _Node ?? (_Node = new CNodeReference(Model));
			}
		}

		private CNodeReference _Node = null;
	}
}
