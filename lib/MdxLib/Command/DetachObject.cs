...
{
	internal sealed class CDetachObject<T> : ICommand where T : Model.CObject<T>
	{
		public CDetachObject(Model.CObjectReference<T> ObjectReference, T Object)
		{
			CurrentObjectReference = ObjectReference;
			Unknown = Object as Model.CUnknown;
			OldObject = Object;
		}
		...
		private Model.CObjectReference<T> CurrentObjectReference = null;
		private Model.CUnknown Unknown = null;
