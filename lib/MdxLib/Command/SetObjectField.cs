...
{
	internal sealed class CSetObjectField<T1, T2> : ICommand where T1 : Model.CObject<T1>
	{
		public CSetObjectField(T1 Object, string FieldName, T2 Value)
		{
			FieldInfo = typeof(T1).GetField(FieldName, System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
