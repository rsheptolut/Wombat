...
{
	internal sealed class CRemoveAt<T> : ICommand where T : Model.CObject<T>
	{
		public CRemoveAt(Model.CObjectContainer<T> Container, int Index, System.Collections.Generic.IEnumerable<Model.CDetacher> DetacherList)
		{
