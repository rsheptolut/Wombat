...
namespace MdxLib.Command
{
	...
	{
		public CSetModelField(Model.CModel Model, string FieldName, T Value)
		{
			FieldInfo = typeof(Model.CModel).GetField(FieldName, System.Reflection.BindingFlags.Public | System.Reflection.BindingFlags.NonPublic | System.Reflection.BindingFlags.Instance);
			CurrentModel = Model;
		...
		private Model.CModel CurrentModel = null;
