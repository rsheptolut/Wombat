...
namespace MdxLib.Command
{
	...
	{
		public CDetachNode(Model.CNodeReference NodeReference, Model.INode Node)
		{
			CurrentNodeReference = NodeReference;
			Unknown = Node as Model.CUnknown;
			OldNode = Node;
		}
		...
		private Model.CNodeReference CurrentNodeReference = null;
		private Model.CUnknown Unknown = null;
		private Model.INode OldNode = null;
	}
}
