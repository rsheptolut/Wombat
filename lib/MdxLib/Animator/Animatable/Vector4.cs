...
{
	internal sealed class CVector4 : CAnimatable<Primitives.CVector4>
	{
		public CVector4(Primitives.CVector4 DefaultValue) : base(DefaultValue)
		{
			//Empty
		}
		...
		public override Primitives.CVector4 InterpolateLinear(CTime Time, CAnimatorNode<Primitives.CVector4> Node1, CAnimatorNode<Primitives.CVector4> Node2)
		{
			...
			float W = (Node1.Value.W * InverseFactor) + (Node2.Value.W * Factor);
		...
		public override Primitives.CVector4 InterpolateBezier(CTime Time, CAnimatorNode<Primitives.CVector4> Node1, CAnimatorNode<Primitives.CVector4> Node2)
		{
			...
			float W = (Node1.Value.W * Factor1) + (Node1.OutTangent.W * Factor2) + (Node2.InTangent.W * Factor3) + (Node2.Value.W * Factor4);
